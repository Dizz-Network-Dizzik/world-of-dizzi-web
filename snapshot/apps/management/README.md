...
| [docs/03_VERNETZUNG.md](docs/03_VERNETZUNG.md) | Was die App teilt / wovon sie abhängt |
| [docs/04_CHANNEL_VORBEREITUNG.md](docs/04_CHANNEL_VORBEREITUNG.md) | Kanal-Adapter-Slots (Gesetz 5, dormant) |
