...
**Zweck:** Kompakter, nach Sektoren gegliederter Nachrichten-Überblick aus seriösen Fixquellen.
...
**Status:** Scaffolding (Kern folgt nach der geteilten Architektur, siehe Gesamtplan).
**Port-Vorschlag (Core):** 8216.
