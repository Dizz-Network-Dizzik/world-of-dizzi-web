...
FAKTEN: list[dict] = [
    ...
    dict(name="pages",
         ...
         # "seventeen" followed on 05.09.2026, with /schwelle/.
         # "sixteen" followed on 04.09.2026, with /balance/.
         ...
         woerter={"seventeen": 17, "siebzehn": 17, "sixteen": 16, "sechzehn": 16,
                  "fifteen": 15, "fünfzehn": 15, "twelve": 12, "zwölf": 12,
                  "eleven": 11, "elf": 11, "ten": 10, "zehn": 10},
         wortmuster=[r"\b(seventeen|sixteen|fifteen|twelve|eleven|ten)\s+pages\b",
                     r"\b(siebzehn|sechzehn|fünfzehn|zwölf|elf|zehn)\s+Seiten\b"],
